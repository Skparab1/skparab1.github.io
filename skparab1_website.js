...
function draw() {
  ...
  fill(countervar-250,0,0);
  stroke(0);
  textSize(23);
  text("Articles written by Skparab1",countervar/20+10,363);
  
  stroke(countervar-250,countervar-250,0);
  ...
  fill(countervar-250,countervar-250,0);
  stroke(0);
  ...
  text('Popular github repos',75,1200);
...
function mouseClicked(){
  ...
  } else if (mouseX > 75 && mouseX < 475 && mouseY > 775+500 && mouseY < 3775+600){
    window.open('http://github.com/skparab1/python-samples');
  } 
  ...
  //window.open('http://skparab1.github.io');
}
